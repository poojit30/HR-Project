    ...
    <div className="navbar-full-container">
      ...
      <div className={scrolled ? 'scrolled' : 'disappear-nav'}>
        <div className="short-details">
          <p><FontAwesomeIcon icon={faPhone} className="entry-social"/><a href="tel: 0000000000" className="gmail-tel-link">00000000000</a></p>
          <p><FontAwesomeIcon icon={faMailBulk} className="entry-social" /><a href="mailto: vit@vitstudent.ac.in" className="gmail-tel-link">vit@vitstudent.ac.in</a></p>
          <p><FontAwesomeIcon icon={faLocation} className="entry-social" /><a href = "https://www.google.com/maps/dir//Vellore+Institute+of+Technology+Chennai+Campus+(VIT+Chennai),+Kelambakkam+-+Vandalur+Rd,+Rajan+Nagar,+Chennai,+Tamil+Nadu+600127/@12.8406343,80.1509549,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x3a5259af8e491f67:0x944b42131b757d2d!2m2!1d80.1534283!2d12.840641?entry=ttu">Chennai | Hyderabad</a></p>
        </div>
