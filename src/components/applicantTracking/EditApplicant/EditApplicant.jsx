        ...
        <div className="edit-bg"> 
          ...
          <div className="edit-form">
           ...
           <div className="documents">
              <a href="https://www.resume.com/sample/" > <FontAwesomeIcon icon={faFile} className="icons" />Resume</a>
              <a href='https://www.resume.com/sample/'> <FontAwesomeIcon  icon={faFile} className="icons"/>Cover Letter</a>
           </div>
