    ...
    <div className="card" >
        <section>
          ...
          <div className='details-for-employee'>
            <h3 onClick={handleEmployeeCardClick} className='employee-name'>{employee.name}</h3>
          ...
          <div className='other-details'>
              <section className='other-details-flex'>
                <h5>Status: </h5>
                <h5 className='content-list'>{employee.leaveHistory[0].status}</h5>
              </section>
              <section className='other-details-flex'>
                <h5>Leave Balance: </h5>
          ...
          <div className='view-applicant-btn'>
            <button onClick={handleEmployeeCardClick}>View Employee</button>
          </div>
